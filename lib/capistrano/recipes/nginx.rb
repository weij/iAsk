Capistrano::Configuration.instance.load do
    ...
    _cset :nginx_path_prefix, "#{shared_path}/config/nginx" 
    ...
    _cset(:nginx_remote_config) { "#{nginx_path_prefix}/conf.d/#{application}.site.conf" }
    ...
    _cset(:nginx_pid) { "#{shared_path}/pids/nginx.pid" } 
